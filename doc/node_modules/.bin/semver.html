...
<span class="hljs-keyword">let</span> versions = []

<span class="hljs-keyword">const</span> range = []

<span class="hljs-keyword">let</span> inc = <span class="hljs-literal">null</span>
...
<span class="hljs-keyword">let</span> loose = <span class="hljs-literal">false</span>

<span class="hljs-keyword">let</span> includePrerelease = <span class="hljs-literal">false</span>

<span class="hljs-keyword">let</span> coerce = <span class="hljs-literal">false</span>

<span class="hljs-keyword">let</span> rtl = <span class="hljs-literal">false</span>

<span class="hljs-keyword">let</span> identifier

<span class="hljs-keyword">const</span> semver = <span class="hljs-built_in">require</span>(<span class="hljs-string">'../'</span>)

<span class="hljs-keyword">let</span> reverse = <span class="hljs-literal">false</span>
...
<span class="hljs-keyword">const</span> main = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
  ...
  <span class="hljs-keyword">while</span> (argv.length) {
    <span class="hljs-keyword">let</span> a = argv.shift()
    <span class="hljs-keyword">const</span> indexOfEqualSign = a.indexOf(<span class="hljs-string">'='</span>)
  ...
  <span class="hljs-keyword">const</span> options = { <span class="hljs-attr">loose</span>: loose, <span class="hljs-attr">includePrerelease</span>: includePrerelease, <span class="hljs-attr">rtl</span>: rtl }

  versions = versions.map(<span class="hljs-function">(<span class="hljs-params">v</span>) =&gt;</span> {
    <span class="hljs-keyword">return</span> coerce ? (semver.coerce(v, options) || { <span class="hljs-attr">version</span>: v }).version : v
  }).filter(<span class="hljs-function">(<span class="hljs-params">v</span>) =&gt;</span> {
  ...
  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>, l = range.length; i &lt; l; i++) {
    versions = versions.filter(<span class="hljs-function">(<span class="hljs-params">v</span>) =&gt;</span> {
...
<span class="hljs-keyword">const</span> failInc = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
...
<span class="hljs-keyword">const</span> fail = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> process.exit(<span class="hljs-number">1</span>)

<span class="hljs-keyword">const</span> success = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
  <span class="hljs-keyword">const</span> compare = reverse ? <span class="hljs-string">'rcompare'</span> : <span class="hljs-string">'compare'</span>
  versions.sort(<span class="hljs-function">(<span class="hljs-params">a, b</span>) =&gt;</span> {
  ...
  }).forEach(<span class="hljs-function">(<span class="hljs-params">v, i, _</span>) =&gt;</span> { <span class="hljs-built_in">console</span>.log(v) })
}

<span class="hljs-keyword">const</span> help = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> <span class="hljs-built_in">console</span>.log(
<span class="hljs-string">`SemVer <span class="hljs-subst">${version}</span>
...
multiple versions to the utility will just sort them.`</span>)
