...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/acorn/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#main-parser">Main parser</a>
      </div>

      <div class="heading h4">
        <a href="#note-on-using-with-escodegen">Note on using with Escodegen</a>
      </div>

      <div class="heading h3">
        <a href="#distacorn_loose.js">dist/acorn_loose.js</a>
      </div>

      <div class="heading h3">
        <a href="#distwalk.js">dist/walk.js</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="acorn">
  <h1>
    <a href="#acorn" name="acorn" class="pilcrow"></a>
Acorn
  </h1>
</div>
<p><a href="https://travis-ci.org/ternjs/acorn"><img src="https://travis-ci.org/ternjs/acorn.svg?branch=master" alt="Build Status"></a>
<a href="https://www.npmjs.com/package/acorn"><img src="https://img.shields.io/npm/v/acorn.svg" alt="NPM version"></a>
<a href="https://cdnjs.com/libraries/acorn"><img src="https://img.shields.io/cdnjs/v/acorn.svg" alt="CDNJS"></a><br>
<a href="https://marijnhaverbeke.nl/fund/">Author funding status: <img src="https://marijnhaverbeke.nl/fund/status_s.png?force" alt="maintainer happiness"></a></p>
...
<pre><code class="sh">npm install acorn
</code></pre>
<p>Alternately, download the source.</p>
<pre><code class="sh">git <span class="hljs-built_in">clone</span> https://github.com/ternjs/acorn.git
</code></pre>
...
<div class="pilwrap" id="main-parser">
  <h3>
    <a href="#main-parser" name="main-parser" class="pilcrow"></a>
Main parser
  </h3>
</div>
...
<ul>
<li>
<p><strong>ecmaVersion</strong>: Indicates the ECMAScript version to parse. Must be
...
<pre><code class="javascript">{
  <span class="hljs-string">"type"</span>: <span class="hljs-string">"Line"</span> | <span class="hljs-string">"Block"</span>,
  <span class="hljs-string">"value"</span>: <span class="hljs-string">"comment text"</span>,
  <span class="hljs-string">"start"</span>: <span class="hljs-built_in">Number</span>,
  <span class="hljs-string">"end"</span>: <span class="hljs-built_in">Number</span>,
  <span class="hljs-comment">// If `locations` option is on:</span>
  <span class="hljs-string">"loc"</span>: {
    <span class="hljs-string">"start"</span>: {<span class="hljs-attr">line</span>: <span class="hljs-built_in">Number</span>, <span class="hljs-attr">column</span>: <span class="hljs-built_in">Number</span>}
    <span class="hljs-string">"end"</span>: {<span class="hljs-attr">line</span>: <span class="hljs-built_in">Number</span>, <span class="hljs-attr">column</span>: <span class="hljs-built_in">Number</span>}
  },
  <span class="hljs-comment">// If `ranges` option is on:</span>
  <span class="hljs-string">"range"</span>: [<span class="hljs-built_in">Number</span>, <span class="hljs-built_in">Number</span>]
}
</code></pre>
<p>Note that you are not allowed to call the parser from the
callback—that will corrupt its internal state.</p>
...
<p><strong>getLineInfo</strong><code>(input, offset)</code> can be used to get a <code>{line, column}</code> object for a given program string and character offset.</p>
<p><strong>tokenizer</strong><code>(input, options)</code> returns an object with a <code>getToken</code>
method that can be called repeatedly to get the next token, a <code>{start, end, type, value}</code> object (with added <code>loc</code> property when the
...
<pre><code class="javascript"><span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> token <span class="hljs-keyword">of</span> acorn.tokenizer(str)) {
  <span class="hljs-comment">// iterate over the tokens</span>
}

<span class="hljs-comment">// transform code to array of tokens:</span>
<span class="hljs-keyword">var</span> tokens = [...acorn.tokenizer(str)];
</code></pre>
...
<div class="pilwrap" id="note-on-using-with-escodegen">
  <h4>
    <a href="#note-on-using-with-escodegen" name="note-on-using-with-escodegen" class="pilcrow"></a>
Note on using with <a href="https://github.com/estools/escodegen">Escodegen</a>
  </h4>
</div>
<p>Escodegen supports generating comments from AST, attached in
Esprima-specific format. In order to simulate same format in
Acorn, consider following example:</p>
<pre><code class="javascript"><span class="hljs-keyword">var</span> comments = [], tokens = [];

<span class="hljs-keyword">var</span> ast = acorn.parse(<span class="hljs-string">'var x = 42; // answer'</span>, {
	<span class="hljs-comment">// collect ranges for each node</span>
	<span class="hljs-attr">ranges</span>: <span class="hljs-literal">true</span>,
	<span class="hljs-comment">// collect comments in Esprima's format</span>
	<span class="hljs-attr">onComment</span>: comments,
	<span class="hljs-comment">// collect token ranges</span>
	<span class="hljs-attr">onToken</span>: tokens
});

<span class="hljs-comment">// attach comments using collected information</span>
escodegen.attachComments(ast, comments, tokens);

<span class="hljs-comment">// generate code</span>
<span class="hljs-built_in">console</span>.log(escodegen.generate(ast, {<span class="hljs-attr">comment</span>: <span class="hljs-literal">true</span>}));
<span class="hljs-comment">// &gt; 'var x = 42;    // answer'</span>
</code></pre>
<div class="pilwrap" id="distacorn_loose.js">
  <h3>
    <a href="#distacorn_loose.js" name="distacorn_loose.js" class="pilcrow"></a>
dist/acorn_loose.js
  </h3>
</div>
...
tokenizer.</p>
<div class="pilwrap" id="distwalk.js">
  <h3>
    <a href="#distwalk.js" name="distwalk.js" class="pilcrow"></a>
dist/walk.js
  </h3>
</div>
...
<div class="pilwrap" id="command-line-interface">
  <h2>
    <a href="#command-line-interface" name="command-line-interface" class="pilcrow"></a>
...
<ul>
<li>
<p><code>--ecma3|--ecma5|--ecma6|--ecma7</code>: Sets the ECMAScript version to parse. Default is
version 5.</p>
</li>
<li>
...
<div class="pilwrap" id="build-system">
  <h2>
    <a href="#build-system" name="build-system" class="pilcrow"></a>
Build system
  </h2>
</div>
...
functions for the chosen plugins are called with <code>(parser, configValue)</code> arguments. They are expected to use the <code>parser.extend</code>
method to extend parser methods. For example, the <code>readToken</code> method
could be extended like this:</p>
<pre><code class="javascript">parser.extend(<span class="hljs-string">"readToken"</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">nextMethod</span>) </span>{
  <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">code</span>) </span>{
    ...
    <span class="hljs-keyword">return</span> nextMethod.call(<span class="hljs-keyword">this</span>, code)
  }
})
</code></pre>
...
normal parser:</p>
<pre><code class="javascript">looseParser.extend(<span class="hljs-string">"readToken"</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">nextMethod</span>) </span>{
  <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"Reading a token in the loose parser!"</span>)
    <span class="hljs-keyword">return</span> nextMethod.call(<span class="hljs-keyword">this</span>)
  }
})
</code></pre>
<div class="pilwrap" id="existing-plugins">
  <h3>
    <a href="#existing-plugins" name="existing-plugins" class="pilcrow"></a>
Existing plugins
  </h3>
</div>
<ul>
...
<li><a href="https://github.com/MatAtBread/acorn-es7-plugin/"><code>acorn-es7-plugin</code></a>: Parse <a href="https://github.com/tc39/ecmascript-asyncawait">async/await syntax proposal</a></li>
<li><a href="https://github.com/UXtemple/acorn-object-spread"><code>acorn-object-spread</code></a>: Parse <a href="https://github.com/sebmarkbage/ecmascript-rest-spread">object spread syntax proposal</a></li>
<li><a href="https://www.npmjs.com/package/acorn-es7"><code>acorn-es7</code></a>: Parse <a href="https://github.com/wycats/javascript-decorators">decorator syntax proposal</a></li>
<li><a href="https://www.npmjs.com/package/acorn-objj"><code>acorn-objj</code></a>: <a href="http://www.cappuccino-project.org/learn/objective-j.html">Objective-J</a> language parser built as Acorn plugin</li>
</ul>
</div>
  </div>
</body>
